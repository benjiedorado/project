...
p{
    ...
    <div class="card col-md-8"> 
 	<div class="card-body">
	    <center> <label for="" class="control-label" style="font-size:1.5rem;">Log in</label></center>
	<form action="includes/login.inc.php" method="POST" class="card">
		...
		<button  type="submit" class="btn-sm btn-block btn-wave col-md-4 btn-primary" name="submit">Log in</button>
        </center>
