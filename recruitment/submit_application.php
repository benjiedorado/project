	...
	<div class="col-md-12">
		...
		<div class="row form-group">
			<div class="col-md-4">
			  ...
			  <input type="text" class="form-control lastname" name="lastname" value="<?php echo$_SESSION['userlname']; ?>"  readonly>
			</div>
			<div class="col-md-4">
				<label for="" class="control-label">First Name</label>
				<input type="text" class="form-control firstname" name="firstname" value="<?php echo$_SESSION['userfname']; ?>"  readonly>
			</div>
			<div class="col-md-4">
				<label for="" class="control-label">Middle Name</label>
				<input type="text" class="form-control" name="middlename" required="" placeholder="(optional)">
			</div>
		</div>
		<div class="row form-group">
			<div class="col-md-4">
			...
			<div class="col-md-4">
				...
				<input type="email" class="form-control email" name="email" value="<?php echo$_SESSION['useremail']; ?>"  readonly  >
			</div>
			<div class="col-md-4">
				<label for="" class="control-label">Contact</label>
				<input type="number" class="form-control" name="contact" required="" placeholder="+63">
			</div>
		</div>
		<div class="row form-group">
			<div class="col-md-7">
		...
		<label for="" class="control-label">Resume</label>
		  <!-- <span class="input-group-text" id="mySpan">Resume</span> -->
		<div class="row form-group">
...
<script >
	bootstrapValidate('.firstname', 'required:Fill out this field!')
	bootstrapValidate('.lastname', 'required:Fill out this field!')
	bootstrapValidate('.email', 'required:Fill out this field!')
</script>