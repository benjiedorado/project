            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200 ">
                    <div class="flex flex-column flex-wrap mb-4 ">
                        ...
                        <a href="{{ route('student_sent_messages') }}" class="p-2 ml-1 rounded-3xl">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 inline-flex" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                            </svg>Sent Messages
                        </a>
                    ...
                    @foreach($queryMessage as $message)
                        ...
                        <hr class="w-full my-4 ">
                                Send by:{{ $message->sender_name }} {{ $message->created_at}}
                       </div>
                        </div>
...
{{--                                                    </div>--}}
                                                    ...
                                                    <form action="{{ route('store.reply',$message->sender_id) }}" method="POST">
                                                        @csrf
                                                    <div class="mt-2 ">
                                                        <x-label for="firstname" :value="__('To:')" />

                                                        <x-input id="firstname" class="block mt-1 w-full" type="text" name="firstname" value="{{ $message->sender_name }}" required autofocus readonly/>
                                                    </div>
