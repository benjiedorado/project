        ...
        <div class="flex flex-col max-w-sm px-6 py-4 mx-auto bg-white rounded-lg shadow-md">
            ...
            <div style='border-bottom: 2px solid #eaeaea'>
                <ul class='flex cursor-pointer'>
                    <a href="{{ route('student_inbox_messages') }}"><li class='py-2 px-6 bg-white rounded-t-lg text-gray-500 bg-gray-200'>Teacher</li></a>
                    <a href="{{ route('create_message_student') }}"><li class='py-2 px-6 bg-white rounded-t-lg '>Student</li></a>
                </ul>
            </div>
