...
@section('content')
<!--sidenav for creating message for student-->
    <x-app-layout>
        ...
        <div class="hidden w-4/12 -mx-8 lg:block float-right relative top-11 mr-4 ml-4 md:max-w-full" >
            <div class="px-8">
                <div class="flex flex-col max-w-sm px-6 py-4 mx-auto bg-white rounded-lg shadow-md">
                    <h1 class="mb-4 text-xl font-bold text-gray-700 ml-4">Create  Message</h1>
                    <div style='border-bottom: 2px solid #eaeaea'>
                        <ul class='flex cursor-pointer'>
                            <a href="{{ route('inbox_messagesBox') }}"><li class='py-2 px-6 bg-white rounded-t-lg'>Teacher</li></a>
                             <a href="{{ route('create_message_student') }}"><li class='py-2 px-6 bg-white rounded-t-lg text-gray-500 bg-gray-200'>Student</li></a>
                        </ul>
                    </div>
                                <form action="{{ route('student.student.message.store') }}" method="POST" enctype="multipart/form-data">
                                    @csrf
                                    <div>To:</div>
                                    <select name="student" id="" class="w-full rounded-lg mt-2 mb-2">
                    ...
                    <div class="p-6 bg-white border-b border-gray-200 ">
                       ...
                       @foreach($sent_message as $message)
                        <div class="p-8 rounded-xl mb-6" style="border:1px solid; border-radius: 10px;">
                            ...
                            {{ $message->receiver_name}} {{ $message->created_at}}
                        </div>
                            <div x-data="{open:false}"  >
                                <div class=" relative bottom-16 mt-1 left-96 m-4 "><a @click.prevent="open = true" href="" >Remove</a></div>
                                ...
                                <div class="fixed z-auto inset-0 overflow-y-auto" aria-labelledby="modal-title" role="dialog" aria-modal="true" id="yourModal" x-show="open" >
                                    <div class="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
                                        ...
                                        <div class="inline-block align-bottom bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full">
                                            ...
                                            <form action="{{ route('message_delete',$message->message_sent_id)  }}" method="POST">
                                                @csrf
