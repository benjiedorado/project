...
{{--                        <x-application-logo class="block h-10 w-auto fill-current text-gray-600" />--}}
                        <img src="{{ asset('acandemic_logo.png') }}" class="block w-60 h-24 w-auto fill-current text-gray-600" alt="">
                    </a>
                </div>
...
{{--                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">--}}
{{--                    <x-nav-link :href="route('tclass.classwork')">--}}
{{--                        {{ __('Class Work') }}--}}
{{--                    </x-nav-link>--}}
{{--                </div>--}}

{{--                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">--}}
{{--                    <x-nav-link :href="route('people')">--}}
{{--                        {{ __('People') }}--}}
{{--                    </x-nav-link>--}}
{{--                </div>--}}
{{--                 <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">--}}
...
{{--                @endif--}}
            ...
            <div class="flex space-x-2 ">
                <div class="relative w-9 h-9 top-4 right-6 overflow-hidden">
            ...
            <div class="hidden sm:flex sm:items-center sm:ml-6">
                <x-dropdown align="right" width="48">
                    ...
                    <x-slot name="content">
                        ...
                        <x-dropdown-link :href="route('avatar')" >
                            {{ __('Change Avatar') }}
                        </x-dropdown-link>
